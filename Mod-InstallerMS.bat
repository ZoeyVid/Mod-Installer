...
curl -sL -o %0 https://raw.githubusercontent.com/SanCraftDev/Mod-Installer/main/Mod-InstallerMS.bat
curl -sL -o MC-Launcher.bat https://raw.githubusercontent.com/SanCraftDev/Mod-Installer/main/MC-LauncherMS.bat
...
java -jar fabric.jar client -mcversion 1.17.1 -launcher microsoft_store -loader %lfl%
del /S /Q fabric.jar
GOTO mif
...
curl -sL -o Installer-Uninstaller.bat https://raw.githubusercontent.com/SanCraftDev/Mod-Installer/main/Installer.bat & start "" "%appdata%\.minecraft\Installer-Uninstaller.bat"
EXIT /B
